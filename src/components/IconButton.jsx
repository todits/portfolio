...
export default function IconButton({ iconselect, image, iconName }) {
   return (
      <button onClick={iconselect} className="flex place-items-center group ">
         ...
         />
         <div className="self-center ml-[-110px] text-[18px] scale-0 group-hover:scale-100  pl-2 max-md:hidden group-hover:ml-0 duration-500 w-[110px] whitespace-nowrap font-bold text-custom-third hover:text-custom-secondary">
